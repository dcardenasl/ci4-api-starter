...
- `docs/` includes supplementary documentation; `swagger.json` is generated by the OpenAPI task.
...
- `php spark swagger:generate` regenerates `swagger.json` from annotations.
