...
This generates the complete CRUD module (migration, controller, service, interface, DTO, model, entity, docs, i18n, tests).
...
The migration was automatically generated by `make:crud`. After migrating, align model/entity fields if you made manual changes to the migration.
