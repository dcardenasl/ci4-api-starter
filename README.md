...
- Generate and align CRUD layers (entities, models, DTOs, services, controllers, routes, tests)
- Guide the migration step explicitly (migration files are not auto-generated by `make:crud`)
