...
// API Keys
$routes->group('api-keys', ['filter' => ['jwtauth', 'permission:iam.admin-access', 'throttle']], function ($routes) {
...
// Metrics
$routes->group('metrics', ['filter' => ['jwtauth', 'permission:iam.admin-access', 'throttle', 'featureToggle:metrics']], function ($routes) {
...
// Audit
$routes->group('audit', ['filter' => ['jwtauth', 'permission:iam.admin-access', 'throttle']], function ($routes) {
