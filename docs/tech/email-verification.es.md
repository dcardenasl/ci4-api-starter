...
- `app/Database/Migrations/2026-01-29-200123_AddEmailVerificationToUsers.php`
...
- Endpoints: `GET /api/v1/auth/verify-email` (token en query), `POST /api/v1/auth/resend-verification`.
