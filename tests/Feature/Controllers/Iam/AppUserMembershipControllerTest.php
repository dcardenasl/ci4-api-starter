...
/**
 * HTTP smoke tests for AppUserMembershipController. The default route group wraps
 ...
 * @internal
 */
final class AppUserMembershipControllerTest extends ApiTestCase
{
    public function testIndexRequiresAuthentication(): void
    {
        $this->clearTestRequestHeaders();
        $result = $this->get('/api/v1/iam/memberships');
